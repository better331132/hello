...
myconn = mu.get_mysql_conn("betterdb")
...
#     sql_create_job_history = '''create table Job_history(employee_id smallint unsigned not null primary key,
...
with conn_mysql_betterdb:
    ...
    cur.execute(sql_insert_department, rows_departments)
